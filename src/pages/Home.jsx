  ...
  return (
    <section className="min-h-screen relative bg-gradient-to-br from-white via-blue-50 to-indigo-100 overflow-hidden pt-20">
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating Orbs */}
        <div className="absolute top-1/4 left-1/4 w-3 h-3 md:w-4 md:h-4 bg-blue-200 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-1/3 right-1/3 w-4 h-4 md:w-6 md:h-6 bg-purple-200 rounded-full blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-1/4 left-1/2 w-2 h-2 md:w-3 md:h-3 bg-cyan-200 rounded-full blur-xl animate-pulse delay-500"></div>

        {/* Gradient Blobs */}
        <div className="absolute -top-32 -left-32 w-64 h-64 md:-top-48 md:-left-48 md:w-96 md:h-96 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full blur-3xl opacity-30 md:opacity-50"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center w-full">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-xl md:rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-lg max-w-max"
            >
            ...
            >
              <Link
                to="/contact"
                className="group relative bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 md:px-8 md:py-4 rounded-lg md:rounded-xl font-semibold text-base md:text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 hover:scale-105 inline-flex items-center justify-center gap-2 md:gap-3"
              >
          ...
          >
            {/* Modern Card Grid */}
            <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl border border-gray-200 p-4 sm:p-6 md:p-8 shadow-xl md:shadow-2xl">
              {/* Main Feature Card */}
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl md:rounded-2xl p-4 md:p-6 text-white mb-4 md:mb-6 cursor-pointer"
              >
                <div className="flex items-center justify-between">
                  <div className="pr-4">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-1 md:mb-2">Full-Stack Engineering</h3>
                    <p className="text-blue-100 text-xs sm:text-sm md:text-base">AI Software + Hardware Validation</p>
                  </div>
                  <Rocket className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white opacity-80 flex-shrink-0" />
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg md:rounded-xl p-3 md:p-4 border border-purple-100 cursor-pointer group"
                >
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center flex-shrink-0">
                      <Brain className="w-4 h-4 md:w-6 md:h-6 text-white" />
                    </div>
                    <div className="min-w-0">
                      <h4 className="font-semibold text-gray-900 text-xs sm:text-sm truncate">AI Engineering</h4>
                      <p className="text-gray-600 text-xs truncate">Machine Learning</p>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  whileHover={{ y: -3, scale: 1.03 }}
                  className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg md:rounded-xl p-3 md:p-4 border border-blue-100 cursor-pointer group"
                >
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center flex-shrink-0">
                      <Cpu className="w-4 h-4 md:w-6 md:h-6 text-white" />
                    </div>
                    <div className="min-w-0">
                      <h4 className="font-semibold text-gray-900 text-xs sm:text-sm truncate">Hardware</h4>
                      <p className="text-gray-600 text-xs truncate">Validation & Testing</p>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  whileHover={{ y: -3, scale: 1.03 }}
                  className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg md:rounded-xl p-3 md:p-4 border border-green-100 cursor-pointer group"
                >
                  <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div className="min-w-0">
                      <h4 className="font-semibold text-gray-900 text-xs sm:text-sm truncate">Cloud</h4>
                      <p className="text-gray-600 text-xs truncate">Native Solutions</p>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  whileHover={{ y: -3, scale: 1.03 }}
                  className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg md:rounded-xl p-3 md:p-4 border border-orange-100 cursor-pointer group"
                >
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg flex items-center justify-center flex-shrink-0">
                      <GitBranch className="w-4 h-4 md:w-6 md:h-6 text-white" />
                    </div>
                    <div className="min-w-0">
                      <h4 className="font-semibold text-gray-900 text-xs sm:text-sm truncate">DevOps</h4>
                      <p className="text-gray-600 text-xs truncate">CI/CD & MLOps</p>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -top-6 -left-6 w-12 h-12 md:-top-8 md:-left-8 md:w-16 md:h-16 bg-white rounded-xl md:rounded-2xl shadow-xl md:shadow-2xl border border-gray-200 flex items-center justify-center"
            >
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -bottom-6 -right-6 w-12 h-12 md:-bottom-8 md:-right-8 md:w-16 md:h-16 bg-white rounded-xl md:rounded-2xl shadow-xl md:shadow-2xl border border-gray-200 flex items-center justify-center"
            >
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center gap-1 md:gap-2 text-gray-600"
        >
          ...
          <div className="w-5 h-8 md:w-6 md:h-10 border-2 border-gray-400 rounded-full flex justify-center">
            <motion.div
              animate={{ y: [0, 12, 0] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="w-1 h-2 md:w-1 md:h-3 bg-gray-500 rounded-full mt-2"
            />
          </div>
        </motion.div>
      </motion.div>
